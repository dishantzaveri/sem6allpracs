...
for i in range(0,x): randomm.append(randomlist[i])
...
print("Time taken to sort the list is ",end-start)
...
print("After applying Random Quick Sort the said list becomes:") 
start = time.time()
